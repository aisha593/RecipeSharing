         ...
         <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
           ...
           <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                @if (count($recipes) > 0)
                    ...
                    <tr><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $loop->iteration }}</td> 
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-red-800 dark:text-red-800">
                         {{-- <a onclick:confirm="Are you sure/n You want to delete?" href="/delet"> --}}
