          ...
          document.addEventListener('DOMContentLoaded', function () {
            ...
            setTimeout(() => {
              ...
              document.querySelector('section#about').classList.remove('hidden');
                ...
                <section id="recipes" class="bg-gray-200 dark:bg-gray-800 py-8 px-4 sm:px-6 lg:px-8">
               ...
               <!-- Include the skeleton -->
                ...
                <!-- Actual content -->
                  <div id="recipe-cards" class="hidden">
                    <!-- Title -->
                      ...
                      @foreach ($recipes as $recipe)
                        ...
                        <div class="group flex flex-col h-full bg-gray-100 border border-gray-200 hover:shadow-lg rounded-xl p-5 dark:border-neutral-700 dark:hover:shadow-black/40 transition">
                          ...
                          <div class="my-4">
                            ...
                            <p class="mt-5 text-gray-600 dark:text-neutral-400">{{ str($recipe->description)->words(10) }}</p>
                            <div class="mt-2 mb-0 text-center">
                              <a href="/register" class="py-2 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-full border border-gray-200 bg-white text-blue-600 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-blue-500 dark:hover:bg-neutral-800">
                                Read more
                                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path d="m9 18 6-6-6-6" />
                                </svg>
